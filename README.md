...
🚧 Not yet written
- **V4L2 Logitech C270 camera driver with OpenCV object detection integration** - using a Logitech C270 webcam to interface with a jetson nano over V4L2 camera driver running YOLOv8 + TensorRT object detection algorithm. *(link to repo)*  
🚧 in progress
---
